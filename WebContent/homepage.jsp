  ...
  <section class="body1">
      ...
      <div id="headerSlider" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="${pageContext.request.contextPath}/images/pictures/banner1.png" class="d-block img-fluid">
          ...
          <div class="carousel-item">
            <img src="${pageContext.request.contextPath}/images/pictures/banner2.png" class="d-block img-fluid">
            <div class="carousel-caption">
              <h5>Dortmund's big player keen on moving to Premier League</h5>
            </div>
          </div>
          <div class="carousel-item">
            <img src="${pageContext.request.contextPath}/images/pictures/banner3.png" class="d-block img-fluid">
            <div class="carousel-caption">
    ...
    <div id="main">
      <div class="main-inner">
        <div id="bigfb">
          <div> <a class="resetFormat football" href="footballnews">FOOTBALL NEWS</a> </div>
        </div>
        </br>
        <div id="lastAndToday">
          <div class="box center">LAST NEWS
          </div>
          <div id="matches" class="box center"> <a href="./transfer.html">TODAY'S
              MATCHES</a>
          </div>
        </div>
          ...
          <div class="twostory">
            <article class="story1">
              ...
              <div class="titlemessi">
                <h3 class="innertitle"
                  title="Only Leo performs miracles! Another Messi masterclass ends Man Utd's dreams">Only Leo performs
                  miracles! Messi magic ends Man Utd dream
                </h3>
              </div>
              </a>
            </article>
            <article class="story2">
              ...
              <div class="titleanh7">
                <h3 class="innertitleanh7"
                  title="‘A waste of money!’ - Ronaldo's Champions League dream ended as Ajax stun Juventus">‘A waste of
                  money!’ - Ronaldo's Champions League dream ended as Ajax stun Juventus
                </h3>
              </div>
              </a>
            </article>
            ...
            <article class="ole">
              ...
              <div class="titleole">
                <h3 class="innertitleole"
                  ...
                  scouring the planet' - Ole's Man Utd transfer vow
                </h3>
              </div>
              </a>
            </article>
        ...
        <!----tags-list--->
        <div class="tags-list" data-module="framework/tags-list" data-module-loaded="true"
          style="touch-action: pan-y; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
          <span class="tags-list_previous aim">
          </span>
          <div class="tags-list_scroller">
            <ul class="tags-list_list clearfix" style="transform: translate3d(0px,0px,0px);">
              <li class="tags-list_tag">
                <a href="https://www.goal.com/en-in/primera-divisi%C3%B3n/34pl8szyvrbwcmfkuocjm3r6t"
                  class="tags-list_link"> Primera División </a>
              </li>
              <li class="tags-list_tag">
                <a href="https://www.goal.com/en-in/premier-league/2kwbbcootiqqgmrzs6o5inle5" class="tags-list_link">
                  Premier League </a>
              </li>
              <li class="tags-list_tag">
                <a href="https://www.goal.com/en-in/team/manchester-united/6eqit8ye8aomdsrrq0hk3v7gh"
                  class="tags-list_link"> Manchester United </a>
              </li>
              <li class="tags-list_tag">
                <a href="https://www.goal.com/en-in/team/barcelona/agh9ifb2mw3ivjusgedj7c3fe" class="tags-list_link">
                  Barcelona </a>
              </li>
              <li class="tags-list_tag">
                <a href="https://www.goal.com/en-in/team/liverpool/c8h9bw1l82s06h77xxrelzhur"
                  class="tags-list_link">Liverpool</a>
              </li>
            </ul>
          </div>
        </div>
        <div id="more" class="center">
          <div> <a href="https://www.goal.com/en-in/news/1" class="mores" href="more">MORE
              ></a> </div>
        </div>
        <section class="media-group clearfix">
          ...
          <div class="video clearfix" data-group-type="video">
            <article class="videoucl">
              <div class="videoucl1">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/oC18FwzHDYY" 
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
              <div class="videoucl2">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/40VVI8WgW7Q" 
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
              <div class="videoucl3">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/Jk1_LkKA4m4" 
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
            </article>
            <article class="videoeuropa">
              <div class="videoeuropa1">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/Na5ggk5_W7M" 
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
              <div class="videoeuropa2">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/nC5kNBE50V4" 
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
              <div class="videoeuropa3">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/T7t6CQ0__So" 
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
            </article>
            <article class="videopremeir">
              <div class="videopremeir1">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/G3K3f8jwVKs" 
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>

              </div>
              <div class="videppremeir2">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/j2Iv02YRKkA" 
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
              <div class="videopremeir3">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/kNcKJNfrVFw" 
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
            </article>
            <article class="videolaliga">
              <div class="videolaliga1">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/eesmMaAXnqE" 
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
              <div class="videolaliga2">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/S54aWKATqOQ" 
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
              <div class="videolaliga3">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/pTQC5jNpUjk" 
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
            </article>
          ...
          <div class="center bottom">
            <a href="https://www.goal.com/en-in/category/videos/1/1qaufvsub9ydo10adn9s13s8vi" class="morevideo"
              href="morevideo">MORE VIDEO
            </a>
          </div>
        </section>
      </div>
