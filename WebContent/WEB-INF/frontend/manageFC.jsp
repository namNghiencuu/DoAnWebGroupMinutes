...
<link rel="stylesheet"
	href="/MinutesServer/stylesheet/admindashboard/manageFC.css" />
<link rel="stylesheet"
...
<body style="background-color: rgba(128, 128, 128, 0.048);">
	...
	<div id="layout">
		<div class="item">
			<div class="FCLogo">
				<img class="" src="/MinutesServer/images/FCLogo/Arsenal_Logo.png" />
			</div>
			<div class="FCName">Arsenal</div>
		</div>
		<div class="item">
			<div class="FCLogo">
				<img class="" src="/MinutesServer/images/FCLogo/Barcelona_Logo.png" />
			</div>
			<div class="FCName">Barcelona</div>
		</div>
		<div class="item">
			<div class="FCLogo">
				<img class="" src="/MinutesServer/images/FCLogo/Chelsea_Logo.png" />
			</div>
			<div class="FCName">Chelsea</div>
		</div>
		<div class="item">
			<div class="FCLogo">
				<img class="" src="/MinutesServer/images/FCLogo/Liverpool_Logo.png" />
			</div>
			<div class="FCName">Liverpool</div>
		</div>
		<div class="item">
			<div class="FCLogo">
				<img class="" src="/MinutesServer/images/FCLogo/MC_Logo.png" />
			</div>
			<div class="FCName">Manchester City</div>
		</div>
		<div class="item">
			<div class="FCLogo">
				<img class="" src="/MinutesServer/images/FCLogo/MU_Logo.jpg" />
			</div>
			<div class="FCName">Manchester United</div>
		</div>
		<div class="item">
			<div class="FCLogo">
				<img class="" src="/MinutesServer/images/FCLogo/Real madrid_Logo.png" />
			</div>
			<div class="FCName">Real Madrid</div>
		</div>
		<div class="item">
			<div class="FCLogo">
				<img class="" src="/MinutesServer/images/FCLogo/Vietnam_Logo.png" />
			</div>
