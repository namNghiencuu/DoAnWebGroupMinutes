...
<link rel="stylesheet" type="text/css"
	href="/MinutesServer/stylesheet/realestate.css" />
</head>
<body>
	<section class="body1">
		<!--Header-->
		<div id="navbar">
			<div class="logo">
				<a><img src="/MinutesServer/images/PageLogo/logo_main.png"
					width="inherit;" /></a>
			</div>
			<div>
				<a href="">Buy</a>
		...
		<div id="mainpage">
			<div class="findhome">
				<img src="/MinutesServer/images/lancastereden.jpg" class="imgfinding" />
				<div class="text">
					<h2>
			...
			<div class="part">
				<div class="whitespace">
					<img src="/MinutesServer/images/pictures/buyhome.png" class="buyhomeimg" />
				...
				<div class="whitespace1">
					<img src="/MinutesServer/images/pictures/sellhome.png"
						class="buyhomeimg" />
				...
				<div class="whitespace2">
					<img src="/MinutesServer/images/pictures/renthome.png"
						class="buyhomeimg" />
		...
		<div id="footer" class="footers" role="contentinfo">
			<div class="inner">
				<div class="logofooter">
					<a href="./homepage.html" class="footerlogo" id="logofooters">
						<img src="/MinutesServer/images/PageLogo/logo_main.png"
						class="footerimage" />
					</a>
				</div>
				<div id="footermenu" class="footermenu" role="navigation">
					...
					<ul class="menu">
						<li class="menuitem"><a href="#" class="contact">About</a></li>
						<li class="menuitem"><a href="#" class="term">Terms and
								Conditions</a></li>
						<li class="menuitem"><a href="#l" class="privacy">Privacy
								Policy</a></li>
						<li class="menuitem"><a href="#" class="career">Careers</a></li>
					</ul>
				</div>
			</div>
			<div id="social" class="socialmedia">
				...
				<ul class="footersocial">
					...
					<div>
						<a href="https://www.instagram.com/binhanred/ " class="icon-insta"><i
							class="fab fa-instagram" aria-hidden="true"></i></a>
					</div>
					<div>
						<a href="https://twitter.com/CuongHuyNg" class="icon-twit"><i
							class="fab fa-twitter" aria-hidden="true"></i></a>
					</div>
					<div>
						<a
							href="https://www.youtube.com/channel/UC0HdtBwDacmZQxQtM5qGw8Q/videos?view=57&flow=grid"
							class="icon-youtb"><i class="fab fa-youtube"
							aria-hidden="true"></i></a>
					</div>
				</ul>
			</div>
			...
			<div>
				<a class="gotopbtn" href="#"> <i class="fas fa-arrow-up"> </i>
				</a>
			</div>
		</div>
	</section>
