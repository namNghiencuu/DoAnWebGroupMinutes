...
<link rel="stylesheet"
	href="/MinutesServer/stylesheet/admindashboard/manageArticle.css" />
<link rel="stylesheet" type="text/css"
	href="/MinutesServer/lib/datatables/css/jquery.dataTables.min.css" />
</head>
...
<body style="background-color: rgba(128, 128, 128, 0.048);">
	...
	<script type="text/javascript"
		src="/MinutesServer/lib/jquery/jquery-1.7.1.min.js"></script>
	<script type="text/javascript"
		src="/MinutesServer/lib/datatables/js/jquery.dataTables.min.js"></script>
	<script>
