...
<html>
  ...
  <body style="background-color: rgba(128, 128, 128, 0.048);">
    ...
    <div id="navbar">
      ...
      <a href="./manageArticle.html" class="navbar-item active"
        >Quản lý bài viết</a
      >
      <a href="./manageFC.html" class="navbar-item">Đội bóng</a>
    ...
    <script
      ...
      src="../public/lib/jquery/jquery-1.7.1.min.js"
    ></script>
    <script
      type="text/javascript"
      src="../public/lib/datatables/js/jquery.dataTables.min.js"
    ></script>
    <script>
