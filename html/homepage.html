        ...
        <section class="media-group clearfix">
          ...
          <div class="video clearfix" data-group-type="video">
            <article class="videoucl">
              <div class="videoucl1">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/oC18FwzHDYY" frameborder="3"
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
              <div class="videoucl2">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/40VVI8WgW7Q" frameborder="3"
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
              <div class="videoucl3">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/Jk1_LkKA4m4" frameborder="0"
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
            </article>
            <article class="videoeuropa">
              <div class="videoeuropa1">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/Na5ggk5_W7M" frameborder="0"
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
              <div class="videoeuropa2">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/nC5kNBE50V4" frameborder="0"
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
              <div class="videoeuropa3">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/T7t6CQ0__So" frameborder="0"
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
            </article>
            <article class="videopremeir">
              <div class="videopremeir1">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/G3K3f8jwVKs" frameborder="3"
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>

              </div>
              <div class="videppremeir2">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/j2Iv02YRKkA" frameborder="3"
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
              <div class="videopremeir3">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/kNcKJNfrVFw" frameborder="0"
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
            </article>
            <article class="videolaliga">
              <div class="videolaliga1">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/eesmMaAXnqE" frameborder="3"
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
              <div class="videolaliga2">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/S54aWKATqOQ" frameborder="3"
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
              <div class="videolaliga3">
                <iframe width="250" height="200" src="https://www.youtube.com/embed/pTQC5jNpUjk" frameborder="3"
                  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                </iframe>
              </div>
            </article>
