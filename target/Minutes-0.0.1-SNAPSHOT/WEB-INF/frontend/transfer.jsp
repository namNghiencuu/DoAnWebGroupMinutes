...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="${pageContext.request.contextPath}/stylesheet/transfer.css"
    />
    <link
      rel="stylesheet"
  ...
  <body>
    <section class="body1">
      ...
      <div id="main">
        <div id="bigfb">
          <div>
            <a class="resetFormat football" href="footballnews"
              >TODAY'S MATCHES</a
            >
          </div>
        </div>
        <h3>Live Football Scores, Fixtures & Results</h3>
        <div class="maininner">
          <div class="results">
            <div class=" premeir">
            ...
            <div class="whitespace">
              ...
              <div class="preft1">
                ...
                <h3 class="score1">Manchester United 2-1 Chelsea</h3>
              </div>
              <hr width="100%" text-align="center" />
              <div class="seeall">
                <a
                  class="seeall1"
                  href="https://www.goal.com/en-in/premier-league/table/2kwbbcootiqqgmrzs6o5inle5"
                  >See Tables ></a
                >
              </div>
            </div>
